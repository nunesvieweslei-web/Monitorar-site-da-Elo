...
def main() -> None:
    ...
    if resumo:
        ...
        try:
            ...
            # Um problema no e-mail (ex.: senha de app errada) NÃO deve
            # derrubar o robô. Anotamos o erro e seguimos em frente.
            print(f"AVISO: não consegui enviar o e-mail: {e}", file=sys.stderr)
            traceback.print_exc()
        salvar_snapshot(novo)  # atualiza a referência mesmo se o e-mail falhar
    else:
